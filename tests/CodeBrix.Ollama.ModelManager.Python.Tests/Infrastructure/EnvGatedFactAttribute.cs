...
/// <summary>
/// A fact that is skipped unless an environment variable is set to the expected value, or unless every one
/// of several variables is set to "1". It is a copy of the attribute the other two test projects carry
/// rather than a shared one, because no test project references another and neither library may grow a
/// dependency to let them.
/// </summary>
