...
/// </summary>
/// <remarks>
/// It sits inside the test assembly's own output folder rather than the system temporary directory, so that the
/// offline suite writes nothing outside the repository.
/// </remarks>
