...
/// <summary>
/// A fact that is skipped unless an environment variable is set to the expected value, or unless every
/// one of several variables is set to "1". Used for the live tests that really download from a registry
/// or from a publisher's own host.
/// </summary>
