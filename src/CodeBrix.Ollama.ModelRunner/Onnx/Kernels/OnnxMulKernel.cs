...
/// <summary>
/// <c>Mul</c>: multiplies two tensors element by element.
/// </summary>
/// <remarks>
...
/// </remarks>
internal sealed class OnnxMulKernel : OnnxKernel,
...
{
    /// <inheritdoc />
    internal override string OpType => "Mul";
    ...
    /// <inheritdoc />
    internal override void Run(OnnxOperatorContext context) => OnnxElementwise.Binary<OnnxMulKernel>(context);
}
