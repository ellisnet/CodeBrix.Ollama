...
/// <summary>
/// <c>Sub</c>: subtracts the second tensor from the first, element by element.
/// </summary>
/// <remarks>
...
/// </remarks>
internal sealed class OnnxSubKernel : OnnxKernel,
...
{
    /// <inheritdoc />
    internal override string OpType => "Sub";
    ...
    /// <inheritdoc />
    internal override void Run(OnnxOperatorContext context) => OnnxElementwise.Binary<OnnxSubKernel>(context);
}
