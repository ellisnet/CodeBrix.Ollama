...
/// <summary>
/// <c>Div</c>: divides the first tensor by the second, element by element.
/// </summary>
/// <remarks>
...
/// <para>
/// Integer division truncates towards zero, as the specification's C semantics ask, and dividing an integer
/// by zero is refused by the runtime rather than given a made-up answer. Float division follows IEEE 754, so
/// a division by zero is an infinity and not an error.
/// </para>
/// </remarks>
internal sealed class OnnxDivKernel : OnnxKernel,
...
{
    /// <inheritdoc />
    internal override string OpType => "Div";
    ...
    /// <inheritdoc />
    internal override void Run(OnnxOperatorContext context) => OnnxElementwise.Binary<OnnxDivKernel>(context);
}
